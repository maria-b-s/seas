...
router.get('/download', function (req, res) {
    if (req.app.locals.promoMode === 'true') {
        ...
        res.redirect(`https://github.com/alphagov/govuk-prototype-kit/archive/v${version}.zip`);
    } else {
        res.redirect('https://github.com/alphagov/govuk-prototype-kit/releases/latest');
    }
});

router.get('/update.sh', function (req, res) {
    res.redirect('https://raw.githubusercontent.com/alphagov/govuk-prototype-kit/main/update.sh');
});
